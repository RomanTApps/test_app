...
class MainActivityScreenShotsTestEs {
    ...
    @Test
    fun test_Snapshot_With_Activity_item1_es() {
    ...
    @Test
    fun test_Snapshot_With_Activity_item2_es() {
    ...
    @Test
    fun test_Snapshot_With_Activity_item3_es() {
        val activity = activityTestRule.launchActivity(null)
        val item1 = activity.findViewById<View>(R.id.item1)
    ...
    @Test
    fun test_Snapshot_With_Activity_item4_es() {
        val activity = activityTestRule.launchActivity(null)
        val item1 = activity.findViewById<View>(R.id.item1)
    ...
    @Test
    fun test_Snapshot_With_Activity_item5_es() {
        val activity = activityTestRule.launchActivity(null)
        val item1 = activity.findViewById<View>(R.id.item1)
    ...
    @Test
    fun test_Snapshot_With_Activity_item6_es() {
        val activity = activityTestRule.launchActivity(null)
        val item1 = activity.findViewById<View>(R.id.item1)
